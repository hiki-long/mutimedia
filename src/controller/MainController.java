...
//	public String select_directory = this.getClass().getClassLoader().getResource("").toExternalForm() + "res/";//选择文件夹记录
	public String select_directory;
	public static ReadDir rd;//读取文件夹的类的实例化对象
	public static ReadLrc[] store_lrc;//每个音乐文件的歌词存储
...
//						System.out.println(media);
						MediaPlayer tplay = new MediaPlayer(media);
					}
				}
